...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 510,466 | 🐛 107 | 📅 2026-09-02

A list of awesome free open source software & libraries for photography. Also tools for video. For more awesomeness, check out [awesome](https://github.com/sindresorhus/awesome) ⭐ 510,466 | 🐛 107 | 📅 2026-09-02.
...
* [PhotoFlow](https://github.com/aferrero2707/PhotoFlow) ⭐ 349 | 🐛 99 | 🌐 C++ | 📅 2021-02-05 - A non-destructive photo retouching program including RAW image development.
...
* [LibGphoto2](https://github.com/gphoto/libgphoto2) ⭐ 1,380 | 🐛 478 | 🌐 C | 📅 2026-09-20 - C APi for Digital camera access and remote control. Java,python,C#, and much more bindings.

### Canon

* [Edsdk4j](https://github.com/kritzikratzi/edsdk4j) ⭐ 117 | 🐛 9 | 🌐 Java | 📅 2023-02-15 - Canon SDK for Java.
* [OfxCanon](https://github.com/roxlu/ofxCanon) ⭐ 45 | 🐛 3 | 🌐 C++ | 📅 2011-11-04 - OpenFrameworks addon for the Canon EDSK.

### GoPro

* [GoPro](https://github.com/joshvillbrandt/goprohero) ⚠️ Archived - A Python library and a CLI that can interface with GoPro HERO3, HERO3+, and HERO4 cameras over http.
* [GoPro](https://github.com/kschzt/gopro) ⭐ 134 | 🐛 1 | 🌐 JavaScript | 📅 2013-05-21 - API for controlling GoPro Hero 3 Camera from Node.js.
* [GoPro](https://github.com/DenisCarriere/gopro) ⭐ 88 | 🐛 6 | 🌐 Python | 📅 2017-05-14 - GoPro Hero 4 - Python API.
* [GoPro.Hero](https://github.com/r1pper/GoPro.Hero) ⭐ 59 | 🐛 10 | 🌐 C# | 📅 2022-06-22 - A lightweight c# library to access and control GoPro HERO.
...
* [digiCamControl](https://github.com/dukus/digiCamControl) ⭐ 734 | 🐛 128 | 🌐 C# | 📅 2025-05-26 - DSLR camera remote control open source software.
* [Remoteyourcam-usb](https://github.com/crazymaik/remoteyourcam-usb) ⭐ 313 | 🐛 0 | 🌐 Java | 📅 2019-09-19 - Control your Canon or Nikon DSLR camera from your Android device through USB.
...
* [Luminance](https://github.com/LuminanceHDR/LuminanceHDR) ⭐ 670 | 🐛 100 | 🌐 C++ | 📅 2026-05-20 - A complete workflow for HDR imaging.
...
* [Simple Gallery](https://github.com/SimpleMobileTools/Simple-Gallery/) ⭐ 4,019 | 🐛 384 | 🌐 Kotlin | 📅 2024-08-18 - A Android gallery app for viewing photos and videos similar to android stock gallery with support for file copy/move/rename/delete/share.
* [Leaf Pic](https://github.com/HoraApps/LeafPic/) ⭐ 3,263 | 🐛 67 | 🌐 Java | 📅 2024-02-14 - Material-designed android gallery alternative.
...
* [Exiv2](https://github.com/Exiv2/exiv2/) ⭐ 1,165 | 🐛 210 | 🌐 C++ | 📅 2026-09-25  - Exiv2 is a C++ library and a command-line utility to read, write, delete and modify Exif, IPTC, XMP and ICC image metadata.
...
* [Open360viewer](https://github.com/TheGreyDiamond/open360viewer) ⭐ 7 | 🐛 0 | 🌐 JavaScript | 📅 2022-11-12 - Open source 360° media viewer.
...
* [Shotcut](https://github.com/mltframework/shotcut) ⭐ 15,276 | 🐛 49 | 🌐 C++ | 📅 2026-09-24 - A free, open source, cross-platform video editor.
...
* [Vid.stab](https://github.com/georgmartius/vid.stab) ⭐ 960 | 🐛 9 | 🌐 C | 📅 2026-08-14 - A video stabilization library which can be plugged-in with Ffmpeg and Transcode.
