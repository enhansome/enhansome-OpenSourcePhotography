...
A list of awesome free open source software & libraries for photography. Also tools for video. For more awesomeness, check out [awesome](https://github.com/sindresorhus/awesome) ⭐ 498,976 | 🐛 106 | 📅 2026-08-21.
...
* [Exiv2](https://github.com/Exiv2/exiv2/) ⭐ 1,157 | 🐛 206 | 🌐 C++ | 📅 2026-08-21  - Exiv2 is a C++ library and a command-line utility to read, write, delete and modify Exif, IPTC, XMP and ICC image metadata.
...
* [Shotcut](https://github.com/mltframework/shotcut) ⭐ 14,963 | 🐛 57 | 🌐 C++ | 📅 2026-08-22 - A free, open source, cross-platform video editor.
